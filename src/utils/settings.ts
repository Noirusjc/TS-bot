...
export async function getClockDateSettings(): Promise<ClockDateSettings> {
  const [
    clockEnabled, clockChannelId, clockFormat, clockUpdateInterval,
    dateEnabled, dateChannelId, dateFormat, dateUpdateInterval,
  ] = await Promise.all([
...
export async function getPokeSettings(): Promise<PokeSettings> {
